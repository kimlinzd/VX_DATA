...
public class SerialPort
{
    ...
    public int read(ByteBuffer buffer) throws IOException
    {
        ...
        else
        {
            throw new IllegalArgumentException(
                    "buffer is not direct and has no array");
        }
    }
    ...
    private native void native_open(FileDescriptor pfd, int speed)
            throws IOException;
    ...
    private native int native_read_direct(ByteBuffer buffer, int length)
            throws IOException;

    private native void native_write_array(byte[] buffer, int length)
            throws IOException;

    private native void native_write_direct(ByteBuffer buffer, int length)
            throws IOException;
