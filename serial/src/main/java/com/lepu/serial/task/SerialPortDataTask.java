 ...
 */
public class SerialPortDataTask<T extends ConsumptionTask> {
    ...
    public SerialPortDataTask<T> setOnTaskListener(OnTaskListener<T> onTaskListener) {
        this.onTaskListener = onTaskListener;
        return this;
    }

    private static SerialPortDataTask lineUpTaskHelp;

    private SerialPortDataTask() {
        // app 只会执行一直
    ...
    public static SerialPortDataTask getInstance() {
        if (lineUpTaskHelp == null) {
            lineUpTaskHelp = new SerialPortDataTask();
        }
