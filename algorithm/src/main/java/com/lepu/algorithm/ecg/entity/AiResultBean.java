...
public class AiResultBean implements Parcelable  {
    ...
    private String signPictureStr;    //   签名图片id cardiot诊断
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(ST60A);
        dest.writeInt(ST80A);
        dest.writeString(signPictureStr);
    }
    ...
    public static AiResultBean manualSetValue(AiResultBean aiResultBean){
        ...
        byte[] waveForm12Array = aiResultBean.getWaveForm12Array();
        if(waveForm12Array != null){
            aiResultBean.setWaveForm12(WaveEncodeUtil.getEcgDataArrayAiAnalysisWaveForm(waveForm12Array,receiveLeadNum));
        }

        byte[] macureValueArray = aiResultBean.getMacureValueArray();
        if(macureValueArray != null){
            aiResultBean.setMeasuredValueList(parseMacureValueArray(macureValueArray,receiveLeadNum));
        }

        return aiResultBean;
    }

    public static List<AiResultMeasuredValueBean> parseMacureValueArray(byte[] macureValueArray,int receiveLeadNum){
        List<AiResultMeasuredValueBean> dataList = new ArrayList<>();

        try{
            byte[] destQRStypeArray = new byte[8];
            byte[] destArray = new byte[2];
            int startIndex = 0;
            for(int i=0;i<receiveLeadNum;i++){
                AiResultMeasuredValueBean item = new AiResultMeasuredValueBean();

                //QRStype	Char[8]
                System.arraycopy(macureValueArray,startIndex,destQRStypeArray,0,destQRStypeArray.length);
                startIndex += destQRStypeArray.length;
                item.setQRStype(new String(destQRStypeArray).trim());

                //short Pa1,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setPa1(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Pa2,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setPa2(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Qa,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setQa(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                // short Ra1,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setRa1(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Ra2,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setRa2(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Sa1,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setSa1(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Sa2,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setSa2(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Ta1,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setTa1(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Ta2,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setTa2(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Ua;
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setUa(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Pd,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setPd(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Qd,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setQd(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Rd1,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setRd1(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Rd2,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setRd2(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Sd1,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setSd1(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Sd2,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setSd2(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Td,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setTd(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short Ud;
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setUd(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short PR,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setPR(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short QT,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setQT(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short QRS,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setQRS(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short VAT
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setVAT(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short STj,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setSTj(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short ST1,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setST1(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short ST2,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setST2(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short ST3,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setST3(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short ST20,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setST20(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short ST40,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setST40(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short ST60,
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setST60(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //short ST80
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setST80(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //Short nRNotch	//R波缺口(0,1,2,3,4:无，上升，下降，两边都有,切迹)
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setnRNotch(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;

                //Short Delta
                System.arraycopy(macureValueArray,startIndex,destArray,0,destArray.length);
                item.setDelta(FormatTransfer.lBytesToShort(destArray));
                startIndex += destArray.length;
...
//            KLog.e(Log.getStackTraceString(e));
    ...
    public static byte[] transferToMacureValueArray(List<AiResultMeasuredValueBean> dataList){
        byte[] macureValueArray =new byte[dataList.size()*72];
        ...
        try{
            ...
            for(int i=0;i<dataList.size();i++){
                AiResultMeasuredValueBean item = dataList.get(i);

                //QRStype	Char[8]
                destQRStypeArray = FormatTransfer.stringToBytes(item.getQRStype(),8);
                System.arraycopy(destQRStypeArray,0,macureValueArray,startIndex,destQRStypeArray.length);
                startIndex += destQRStypeArray.length;
                //item.setQRStype(new String(destQRStypeArray).trim());

                //short Pa1,
                destArray = FormatTransfer.toLH(item.getPa1());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Pa2,
                destArray = FormatTransfer.toLH(item.getPa2());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Qa,
                destArray = FormatTransfer.toLH(item.getQa());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                // short Ra1,
                destArray = FormatTransfer.toLH(item.getRa1());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Ra2,
                destArray = FormatTransfer.toLH(item.getRa2());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Sa1,
                destArray = FormatTransfer.toLH(item.getSa1());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Sa2,
                destArray = FormatTransfer.toLH(item.getSa2());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Ta1,
                destArray = FormatTransfer.toLH(item.getTa1());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Ta2,
                destArray = FormatTransfer.toLH(item.getTa2());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Ua;
                destArray = FormatTransfer.toLH(item.getUa());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Pd,
                destArray = FormatTransfer.toLH(item.getPd());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Qd,
                destArray = FormatTransfer.toLH(item.getQd());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Rd1,
                destArray = FormatTransfer.toLH(item.getRd1());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Rd2,
                destArray = FormatTransfer.toLH(item.getRd2());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Sd1,
                destArray = FormatTransfer.toLH(item.getSd1());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Sd2,
                destArray = FormatTransfer.toLH(item.getSd2());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Td,
                destArray = FormatTransfer.toLH(item.getTd());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short Ud;
                destArray = FormatTransfer.toLH(item.getUd());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short PR,
                destArray = FormatTransfer.toLH(item.getPR());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short QT,
                destArray = FormatTransfer.toLH(item.getQT());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short QRS,
                destArray = FormatTransfer.toLH(item.getQRS());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short VAT
                destArray = FormatTransfer.toLH(item.getVAT());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short STj,
                destArray = FormatTransfer.toLH(item.getSTj());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short ST1,
                destArray = FormatTransfer.toLH(item.getST1());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short ST2,
                destArray = FormatTransfer.toLH(item.getST2());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short ST3,
                destArray = FormatTransfer.toLH(item.getST3());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short ST20,
                destArray = FormatTransfer.toLH(item.getST20());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short ST40,
                destArray = FormatTransfer.toLH(item.getST40());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short ST60,
                destArray = FormatTransfer.toLH(item.getST60());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //short ST80
                destArray = FormatTransfer.toLH(item.getST80());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //Short nRNotch	//R波缺口(0,1,2,3,4:无，上升，下降，两边都有,切迹)
                destArray = FormatTransfer.toLH(item.getnRNotch());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;

                //Short Delta
                destArray = FormatTransfer.toLH(item.getDelta());
                System.arraycopy(destArray,0,macureValueArray,startIndex,destArray.length);
                startIndex += destArray.length;
            }
        }catch (Exception e){
