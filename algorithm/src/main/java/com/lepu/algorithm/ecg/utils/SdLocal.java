...
public class SdLocal {
    ...
    public static final String LEPU_FOLDER_ROOT = "NeoECG";
    public static String LEPU_PATH_SD = "";
    public static final String DEFAULT_USER_ID = "1";//不能用+ - 之类的符号，adb sd卡不能查询里面的内容。 默认值为1 不能修改。数据库userid默认值。
    ...
    public static String getLepuRootPathSD(Context context) {
        if (StringUtil.stringIsEmpty(LEPU_PATH_SD)) {
...
//    }
    ...
    // ===================================================================
//    public static String getSystemScreenshotsFolder(Context context) {
//        String folder = StringUtil.combinePath(
//                SdUtil.getStorgePath(context), "/Pictures/Screenshots");
//
...
//    }
//
//    public static void deleteExportFolder(Context context){
//        String filePath = SdLocal.getExportDataFolder(context);
//        FileUtil.deleteFile(context,new File(filePath));
//    }
//
