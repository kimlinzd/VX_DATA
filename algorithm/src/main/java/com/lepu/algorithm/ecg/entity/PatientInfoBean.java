...
public class PatientInfoBean implements Parcelable, Serializable {
    ...
    private String gainArray0;
    private String gainArray1;
    private long Id = -1;
...
//        }
        ...
        dest.writeString(this.gainArray0);
        dest.writeString(this.gainArray1);
    ...
    protected PatientInfoBean(Parcel in) {
        ...
        this.gainArray0 = in.readString();
        this.gainArray1 = in.readString();
        this.Id = in.readLong();
    }
    ...
    public String getGainArray0() {
        return gainArray0;
    }

    public void setGainArray0(String gainArray0) {
        this.gainArray0 = gainArray0;
    }

    public String getGainArray1() {
        return gainArray1;
    }

    public void setGainArray1(String gainArray1) {
        this.gainArray1 = gainArray1;
    }
